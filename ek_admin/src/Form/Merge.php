...
class Merge extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $info = t('You can merge data from another EK account with the current database. 
        ...
        $form['upload'] = array(
            '#type' => 'file',
            '#title' => t('Select file'),
            '#description' => t('Select a sql file containing the data table to merge'),
            //'#required' => TRUE,
        );
        ...
        $form['table'] = array(
            '#type' => 'textfield',
            '#size' => 30,
            '#attributes' => array('placeholder' => t('Table target name')),
            '#required' => TRUE,
        );
