  ...
  jQuery('.calculate').on('click, change', function(){
    ...
    var sum_credit = 0;
      ...
      for (i = 0; i < jQuery( ".calculate" ).length; i++) { 
        ...
        var difference = (Math.round(difference*100)/100).toFixed(2);
        var credit = (Math.round(credit*100)/100).toFixed(2);
        var debit = (Math.round(debit*100)/100).toFixed(2);
        
        sum_credit = (Math.round(sum_credit*100)/100).toFixed(2);
        sum_debit = (Math.round(sum_debit*100)/100).toFixed(2);
