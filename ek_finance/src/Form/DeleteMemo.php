    ...
    public function buildForm(array $form, FormStateInterface $form_state, $id = null) {
        ...
        if ($data->status == 0) {
            ...
            if ($delete) {
                ...
                $form['alert'] = array(
                    '#type' => 'item',
                    '#markup' => $this->t('Are you sure you want to delete this memo ?'),
                );
                ...
                $form['alert'] = array(
                    '#type' => 'item',
                    '#markup' => $this->t('You are not authorized to delete this memo.'),
                );
            }
        } else {
            $form['alert'] = array(
                '#type' => 'item',
                '#markup' => $this->t('This memo cannot be deleted because it has been fully or partially paid'),
            );
        }
