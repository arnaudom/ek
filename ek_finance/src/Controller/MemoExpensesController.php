...
/**
   *  display for to create internal memo
   *
*/
  public function createinternalmemo(Request $request, $id) {
    ...
    $coid = Database::getConnection('external_db', 'external_db')->query('SELECT entity FROM {ek_expenses_memo} WHERE id=:id AND category<:c ', array(':id' => $id, ':c' => 5 ) )->fetchField();
...
/**
   *  Return form to create a personal memo 
   *
*/
  public function createpersonalmemo($id ) {
    ...
    $uid = Database::getConnection('external_db', 'external_db')
            ->query('SELECT entity FROM {ek_expenses_memo} WHERE id=:id AND category=:c ', 
                    array(':id' => $id, ':c' => 5 ) )->fetchField();
...
*/
  ...
  if(isset($_SESSION['memfilter']['keyword']) 
  ...
  //not keyword
      ...
      if($_SESSION['memfilter']['pcode'] == 'Any') $_SESSION['memfilter']['pcode'] = '%';
