...
/**
 * @file
 * Contains \Drupal\ek_sales\Form\TaskInvoice.
 */
...
/**
 * Provides a form to reecord and edit invoice task alerts.
 */
class TaskInvoice extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $id = null) {
        ...
        if ($data) {
            ...
            $b = Url::fromRoute('ek_sales.invoices.tasks_list', array(), array())->toString();
            $form['back'] = array(
            ...
            $form['info'] = array(
                '#type' => 'item',
                '#markup' => $this->t('You cannot edit this invoice task.'),
            );
