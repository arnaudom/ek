...
$headerline = "<div class='table'><div class='row'><div class='cell'>" . t("Description") . "</div><div class='cell'>" . t("Value") . "</div><div class='cell'>" . t("Formula") . "</div><div class='cell'>" . t("Include tax") . "</div>";
