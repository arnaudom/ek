...
/**/ 
    ...
    $query = "CREATE TABLE IF NOT EXISTS `ek_hr_post_data` (
                ...
                `custom_aw6` DOUBLE UNSIGNED NULL DEFAULT NULL,
                `custom_aw7` DOUBLE UNSIGNED NULL DEFAULT NULL,
    ...
    $query = "CREATE TABLE IF NOT EXISTS `ek_hr_workforce_pay` (
                ...
                `r_day` TINYINT(3) UNSIGNED NULL DEFAULT '0',
                `r_day_val` DOUBLE NULL DEFAULT '0',
                `ph_day` TINYINT(3) UNSIGNED NULL DEFAULT '0',
                `ph_day_val` DOUBLE NULL DEFAULT '0',
                `mc_day` TINYINT(3) UNSIGNED NULL DEFAULT '0',
                `mc_day_val` DOUBLE NULL DEFAULT '0',
                `xr_hours` TINYINT(3) UNSIGNED NULL DEFAULT '0',
                ...
                `custom_aw5` DOUBLE UNSIGNED NULL DEFAULT '0',
                `custom_aw6` DOUBLE UNSIGNED NULL DEFAULT '0',
                `custom_aw7` DOUBLE UNSIGNED NULL DEFAULT '0',
                `custom_aw8` DOUBLE UNSIGNED NULL DEFAULT '0',
                ...
                `commission` DOUBLE UNSIGNED NULL DEFAULT '0',
                `turnover` DOUBLE UNSIGNED NULL DEFAULT '0',
                ...
                `comment` VARCHAR(200) NULL DEFAULT NULL COMMENT 'optional comment',
                PRIMARY KEY (`id`)
              )
              COLLATE='utf8_general_ci'
              ENGINE=InnoDB;
