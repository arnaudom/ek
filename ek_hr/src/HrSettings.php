 ...
 */
  class HrSettings {
         ...
         */
        public function get($setting, $key = null, $data = null) {
            switch ($setting) {
        
            case 'ad':
            case 'allowance_deduction':
                if ($key == null) {
                    return $this->HrAd[$this->coid];
                }
                if ($data == null) {
            ...
            case 'accounts':
                if ($key == null) {
                    return $this->HrAccounts[$this->coid];
                }
                if ($data == null) {
